...
public class RabbitMqConfig {
    ...
    public ConnectionFactory connectionFactory() {
        CachingConnectionFactory connectionFactory = new CachingConnectionFactory("172.27.12.62");
        connectionFactory.setUsername("yKF6600");
        connectionFactory.setPassword("yxs1112003");
